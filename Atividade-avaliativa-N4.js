...
let profissaoUsuario = perguntas.question('Digite sua profissao: ')
let cidadeUsuario = perguntas.question('Digite sua cidade: ')
let emailUsuario = perguntas.question('Digite seu e-mail: ')
let telefoneUsuario = perguntas.questionInt('Digite seu telefone: ')
let anoExperienciaUsuario = perguntas.question('Digite sua experencia(em anos): ')
let disponivelParaFreelance = perguntas.keyInYN('Disponivel para freelance?')
...
| Experiência : ${anoExperienciaUsuario} anos 
| Freelance : ${disponivelParaFreelance} 
============================================`)
...
/*
let materias = ["matematica", "geografia", "historia", "artes", "quimica"];
let frase1 = `A 3ª matéria da lista é ${materias[2]} e a lista tem ${materias.length} matérias no total`;
...
materias.pop("quimica") 
console.log("pop", materias);

materias.unshift("Filosofia");                                                  
console.log("unshift", materias);

materias.shift("matematica");                                                     //c)
console.log("shift",materias);
...
/*significa: não encontrado, pois quando um item não consta na lista ele retornará -1 */
...
let temSalvador = cidadesBrasil.includes("Salvador");
console.log(temSalvador);

let temBelem = cidadesBrasil.includes("Belém");
console.log(temBelem);

console.log(cidadesBrasil.indexOf("Curitiba"))
console.log(cidadesBrasil.indexOf("Recife"))

let todasCidades = cidadesBrasil.concat(cidadesPortugal);
let cidadesDoMeio = (todasCidades.slice(3,7))
...
listaFuncionarios[0].cargo = "distribuidor"
...
/*
let loja = {
    nomeLoja: "Coisa de louco",
    CNPJ: "55.345.456/0001-45",
    endereco: {
        rua: "Valdir Kaiser",
        numero: 89,
        cidade: "Jaraguá",
    ...
    categoriasProdutos: ["Bijuterias", "Roupas", "Acessórios"],
    aberta: true
};
...
console.log(
  `A loja '${loja.nomeLoja}' fica em ${loja.endereco.cidade} - ${loja.endereco.estado} e está aberta: ${loja.aberta}.`
);

loja.categoriasProdutos.push("Calçados");

console.log(
  `Algumas categorias da loja '${loja.nomeLoja}' são: ${loja.categoriasProdutos[0]} e ${loja.categoriasProdutos[loja.categoriasProdutos.length - 1]}.`
);
...
let escola = {
    ...
    turmas: [
        {
            periodo: "Manhã",
            alunos: ["Ana","Jorge","Carlos"]
        },
        {
            periodo: "Tarde",
            alunos: ["Marcos","Eduardo","Maria"]
}
    ]
}
...
escola.turmas[1].alunos.push("Lara")
