...
// while (regressiva < 11 && regressiva > 0) {
...
// let numero = rl.questionInt("Digite um numero inteiro de 1 a 5: ");

// while (numero <= 0 || numero >= 6) {
//     console.log("Valor fora do intervalo. Tente novamente.");
//     numero = rl.questionInt("Digite um numero inteiro de 1 a 5: ");
// }
...
// let numeros = rl.questionInt("Informe um numero inteiro (digite 0 para encerrar o processo): ");
// let soma = 0
// let quant = 0
// let lista = []
...
//     quant++;
//     lista.push(numeros)
//     numeros = rl.questionInt("Informe um numero inteiro (digite 0 para encerrar o processo): ");
// }

// console.log(`Soma dos numeros: ${soma}`);
// console.log(`Quantidade de numeros digitados: ${quant}`);
