...
// let idade = perguntas.questionInt('Qual a sua idade? ')
...
// console.log(`O aluno tirou a nota ${notaAluno} na prova final, o mesmo esta ${status}`)
// console.log("_______________________________");
...
// let temperatura = perguntas.questionFloat('Qual a temperatura atual? ')
...
// let usuario = {
//     nome: perguntas.question('Informe o seu nome: ')
//     possuiIngresso: perguntas.keyInYN('Possui ingresso? ')
//     idade: perguntas.questionInt('Informe a sua idade: ')
// }
...
//     nome: perguntas.question('Informe o seu nome: '),
//     idade: perguntas.questionInt('Informe a sua idade: '),
//     habilitacao: perguntas.keyInYN('Possui habilitacao? '),
// }

// if (motorista.idade >= 21 && motorista.habilitacao) {
//     console.log(motorista.nome,"você pode alugar o veículo seu jumento.")
// } else {
//     console.log(motorista.nome, "você não atende aos requisitos, lamentável.")
// }
...
// let estudante = perguntas.keyInYN('É estudante: ')
// let idoso = perguntas.keyInYN('Tem mais de 60 anos? ')
...
// let aluno = {
//     nome: perguntas.question('Informe o seu nome: '),
//     nota1: perguntas.questionInt('Informe a sua primeira nota: '),
//     nota2: perguntas.questionInt('Informe a sua segunda nota: '),
// }
